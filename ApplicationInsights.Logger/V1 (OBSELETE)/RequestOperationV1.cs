...
{
    public class RequestOperationV1
    {
        /// <summary>
        ...
        public RequestOperationV1(TelemetryClient TelemetryClient, string OperationID)
        {
        ...
        public RequestOperationV1(TelemetryClient TelemetryClient, string DependencyID, string ParentID)
        {
            _telemetryClient = TelemetryClient;
